      ...
      {preppedCard &&
        (state.turn.phase === 'challenge' ? (
          <div className='challenge-popup'>
            ...
            >
              <img
                src='%PUBLIC_URL%/assets/challenge/challenge.png'
                alt='challenge'
                ...
                >
                  ...
                  {state.turn.phase === 'modify' && state.dice.defend && (
                    <div className='summary'>
                      <div>
                        <img src={'%PUBLIC_URL%/assets/sword.png'} alt={''} />
                        <h1
                          style={{
                            color:
                      ...
                      <div>
                        ...
                        <img src={'%PUBLIC_URL%/assets/shield.png'} alt={''} />
                      </div>
                    </div>
                  )}
                  ...
                  <div className='arrows'>
                    {activeDice === 1 ? (
                      ...
                      <img
                        src='%PUBLIC_URL%/assets/sword.png'
                        alt={''}
                        className={`logo`}
                      />
                    )}
                    ...
                    {activeDice === 0 ? (
                      ...
                      <img
                        src='%PUBLIC_URL%/assets/shield.png'
                        alt={''}
                        className={`logo`}
                      />
                    )}
